...
# I already removed redundancy in my code so my function will do something different
# As another level of error handling, catch consecutive bad inputs and close the program if we hit a threshold
def input_error_check():
    # Use the 'global' keyword to modify global variable values within the function, otherwise they will be interpreted within a local scope 
    global INPUT_ERRORS
    global CONT_PROGRAM
